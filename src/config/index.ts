...
const configSchema = z.object({
  // XSpan Cloud (optional — only used with XSpan Premium via health system invite)
  XSPAN_API_KEY: z.string().optional(),
  XSPAN_USER_ID: z.string().optional(),
  XSPAN_API_URL: z.string().url().optional(),
